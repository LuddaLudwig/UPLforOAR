...
```
Convergence results from Bayesian UPL analysis using `UPLforOAR` version
`r packageVersion('UPLforOAR')`. Convergence is assessed quantitatively
...
consideration.
```{r plots,results=FALSE,fig.height=4}
