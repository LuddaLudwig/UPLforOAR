...
content and text specific to your industry, sources, or rule. You can generate 
...
blank reports included in the templates folder. Much like the README.Rmd and 
vignettes, these templates include the analysis and text using an example 
emissions dataset. However, these templates are designed to be copied and then 
customized to the specific rule or pollutant, with the places where you might 
want to make changes pointed out. Optional example text from past MACT floor 
