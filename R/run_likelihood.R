...
#' @param model_input results from setup_likelihood(), including JAGS model script, emissions data, distribution, initial values list, and parameters to monitor.
...
#' @param maxY The maximum emission value possible, used to truncate likelihood distributions and set upper ranges on prior distributions. Default is 3*maximum(data$emissions).
